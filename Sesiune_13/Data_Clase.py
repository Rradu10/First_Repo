...
class Teacher:
    ...
    clase: List = field(default_factory=list)  # se creaza o lista goala pentru fiecare obiect nou
    cod_intern: int = field(init=False, repr=False,
                            default=123)  # acest atribut nu va fi adaugat in constructor si nici in afisare
